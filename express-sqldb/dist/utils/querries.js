...
const querries = {
    ...
    addNewQuestionsQuery: 'INSERT INTO questions (questions_uid, examYear, question, instruction, optionA, optionB, optionC, optionD, optionE, subjectId) VALUES (uuid_generate_v4(), $1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *;',
    getSubjectQuery: 'SELECT * FROM subjects WHERE name = $1',
    getQuestionsQuerry: 'SELECT * FROM questions WHERE subjectId = $1 AND examYear = $2',
    roleQuery: 'SELECT * FROM roles WHERE role_uid = $1',
};
exports.default = querries;
